...
public class ProductRepositoryImpl implements ProductRepository {
   ...
   *
   * <p>Arabic-aware recall is layered on <em>additively</em>: the folded search key ({@code
   * name_search}, generated by the DB {@code fold_search}) is matched against the same fold of the
   * term, so {@code "احمد"} also finds {@code "أحمد"}/{@code "مُحمّد"}-style spelling variants.
   * Using the DB function on both sides keeps the stored key and the query fold consistent by
   * construction.
   */
