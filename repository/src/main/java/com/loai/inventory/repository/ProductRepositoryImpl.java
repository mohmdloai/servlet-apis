...
import com.loai.inventory.repository.generated.Tables;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    @Override
    public List<Product> findAll(int offset, int limit) { /* TODO */ return dsl.selectFrom(PRODUCT)
    ...
    /**
     * Maps a jOOQ ProductRecord to the domain Product.
     * This is the only place in the system that knows about both types.
     * service and api never see ProductRecord.
     */
