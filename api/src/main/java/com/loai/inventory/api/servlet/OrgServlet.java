...
import com.loai.inventory.api.servlet.handler.OgImageHandler;
...
import com.loai.inventory.api.servlet.handler.ReviewHandler;
        ...
        Map.ofEntries(
            ...
            Map.entry(
                ...
                new CashShiftHandler(
                    config.cashShiftService, config.documentRenderService, mapper)),
