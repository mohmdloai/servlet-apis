 ...
 *
 * <p>Responsibilities: contextInitialized → build AppConfig (pool, migrations, jOOQ, services) →
 * store it in ServletContext under key "config" contextDestroyed → close connection pool cleanly
 *
 * <p>Servlets retrieve their services via: AppConfig config = (AppConfig)
