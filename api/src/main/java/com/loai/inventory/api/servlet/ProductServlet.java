 ...
 *
 * Routing is done manually on pathInfo — no framework.
 * This class knows nothing about repositories or jOOQ.
 * It only speaks: HTTP in → service call → HTTP out.
 */
...
public class ProductServlet extends HttpServlet {
    ...
    /**
     * Extracts the UUID from the path: /api/products/{id}
     * Returns null when the path is just /api/products (list endpoint).
     */
